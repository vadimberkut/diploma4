...
//const double color_radius = 3;//6.5;

//const int spatial_radius = 10;
//const double color_radius = 7;//6.5;
...
{
public:
	static const int SPATIAL_RADIUS_DEFAULT;
	static const double COLOR_RADIUS_DEFAULT;//6.5;
	static const int MIN_REGION_SIZE_DEFAULT;

	static int SPATIAL_RADIUS;
	static double COLOR_RADIUS;//6.5;
	static int MIN_REGION_SIZE;
};

//int spatial_radius_MEAN_SHIFT = 10;
//double color_radius_MEAN_SHIFT = 7;//6.5;
